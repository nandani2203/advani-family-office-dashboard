...
>(({ className, children, side = 'right', ...props }, ref) => (
  <SheetPrimitive.Portal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(
        'fixed z-50 flex h-full w-full flex-col gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300 sm:max-w-lg',
        side === 'right'
